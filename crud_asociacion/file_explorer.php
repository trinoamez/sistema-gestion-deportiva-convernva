...
<head>
    ...
    <title>Explorador de Archivos - Logo</title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">
                            <i class="fas fa-images"></i> Explorador de Archivos - Logo
                        </h5>
                        ...
                        <div class="mb-4">
                            ...
                            <form method="POST" enctype="multipart/form-data" id="uploadForm">
                                <div class="upload-area" id="uploadArea">
                                    ...
                                    <input type="file" name="logo_file" id="logoFile" accept=".jpg,.jpeg,.png,.gif,.webp" class="d-none">
        ...
        function selectCurrentFile() {
            if (selectedFile) {
                ...
                if (window.opener && !window.opener.closed) {
                    window.opener.setLogoFile(selectedFile, selectedFileName);
                    window.close();
                } else {
